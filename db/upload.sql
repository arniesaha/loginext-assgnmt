...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2015 at 06:44 PM
...
--
-- Table structure for table `loginext`
--

CREATE TABLE IF NOT EXISTS `loginext` (
`pincode` int(11) NOT NULL,
  `rating` int(11) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=2501 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `loginext`
--

INSERT INTO `loginext` (`pincode`, `rating`) VALUES
(1, 5),
(2, 2),
(3, 8),
(4, 4),
...
(2, '8mHAfIFCO2iom6sqm4Tes3g52dGTiuQeuTsz3PqJ8K2ydJhoUxVACMisi72JVJgI', '', '', '', 1, '2015-03-18 15:18:07', '2015-03-18 15:18:07');
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.66820002, 1, '2015-04-20 08:05:28'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2015-04-20 08:05:28'),
(3, 'Euro', 'EUR', '', '€', '2', 0.92710000, 1, '2015-04-20 08:05:28');
...
(4, 1, 'About Us', '&lt;p&gt;\r\n	About Us&lt;/p&gt;&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;Crafting Emotions&lt;/p&gt;&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;The quick brown fox jumps over the lazy dog!&lt;/p&gt;', 'about-us', '', '');
...
(288, 0, 'config', 'config_email', 'arnab.saha@railtiffin.com', 0),
...
(381, 0, 'config', 'config_seo_url', '1', 0),
(382, 0, 'config', 'config_file_max_size', '300000', 0),
(383, 0, 'config', 'config_file_ext_allowed', 'txt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc\r\nrtf\r\nxls\r\nppt\r\nodt\r\nods', 0),
...
(387, 0, 'config', 'config_encryption', 'edb18315039de4e074fb9192081d0313', 0),
(388, 0, 'config', 'config_compression', '0', 0),
(389, 0, 'config', 'config_error_display', '1', 0),
(390, 0, 'config', 'config_error_log', '1', 0),
(391, 0, 'config', 'config_error_filename', 'error.log', 0),
...
(1, 1, 'admin', 'bad22729820dadc4194cd9f2fb77bc7973c45b87', '1b1f34298', 'John', 'Doe', 'arnab.saha@railtiffin.com', '', '', '::1', 1, '2015-03-18 15:18:07');
...
--
-- Indexes for table `loginext`
--
ALTER TABLE `loginext`
...
--
-- AUTO_INCREMENT for table `loginext`
--
ALTER TABLE `loginext`
MODIFY `pincode` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2501;
--
...
--
ALTER TABLE `oc_setting`
MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=393;
--
